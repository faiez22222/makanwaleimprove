...
const About = () => {
  ...
  return (
   ...
   >
    <Box>
     <Text  fontSize='80px'  fontWeight='500'  mb="8" mt='250px'>
       Who we are
     </Text>
     </Box>
     <Box bgColor='whitesmoke'  w='100%'      align="center"justify="center"    >
     <Box   width={['95%' ,'90%' ,'85%' ,'100%' ,'75%' ,'75%']}    >
       <Text fontSize={['65px' ,'65%' ,'65%' ,'100%' ,'20px' ,'20px']} mb="4" >
         "The Technology-based, Promising, and Authentic construction and Interior designing service company"
       </Text>
       <Text    fontSize={['60px' ,'60px' ,'60px' ,'100%' ,'20px' ,'20px']}  >
     ...
     <Box  justify = 'center' align = 'center' width='100%'   >
      <Flex  {... gridProps}     width='75%'  justify = 'center' align = 'center'     >
        <Box      textAlign='left'    width={['100%' ,'90%' ,'85%' ,'500px' ,'500px' ,'500px']}    >
          <Text fontWeight="bold" fontSize={['70px' ,'60px' ,'60px' ,'100%' ,'20px' ,'20px']}>
            Planning and Architecture Service
          </Text>
          <Text fontSize={['65px' ,'60px' ,'60px' ,'100%' ,'20px' ,'20px']} >
    ...
    <Box  justify = 'center' align = 'center' width='100%'  >
      ...
      <Flex  width=  {['100%' ,'90%' ,'85%' ,'500px' ,'500px' ,'450px']}       >
        <Image
        ...
        <Spacer/>
        <Box      textAlign='left'    width={['100%' ,'90%' ,'85%' ,'500px' ,'600px' ,'600px']}    >
          <Text fontWeight="bold" fontSize={['70px' ,'60px' ,'60px' ,'100%' ,'20px' ,'20px']}>
     ...
     <Box w='100%'  bgColor='red'  justify = 'center' align = 'center'  >
     <Box   width =  {['100%' ,'100%' ,'100%' ,'75%' ,'75%' ,'75%' ]}    bgColor='yellow'  textAlign='left'   >
       <Text fontWeight="normal" fontSize={['60px' ,'60px' ,'60px' ,'100%' ,'20px' ,'20px']}>
     ...
     <Box bgColor='whitesmoke'  w='100%'  mt='150px'     justify = 'center' align = 'center'  >
     <Text  fontSize='80px'  fontWeight='500'  mb="8" mt='250px'>
         Mission
     </Text>
     <Box  width =  {['100%' ,'100%' ,'100%' ,'75%' ,'75%' ,'75%' ]}   textAlign='left'   >
       <Text fontSize={['65px' ,'60px' ,'60px' ,'100%' ,'20px' ,'20px']}  mb="4" >
       ...
       <Text    fontSize={['65px' ,'60px' ,'60px' ,'100%' ,'20px' ,'20px']}  fontWeight='bold'>Friendly working environment</Text>
       <Text fontSize={['65px' ,'60px' ,'60px' ,'100%' ,'20px' ,'20px']}  >
       ...
       <br/>
       <Text  fontSize={['65px' ,'60px' ,'60px' ,'100%' ,'20px' ,'20px']}   fontWeight='bold' >Updated with latest technology and ideas</Text>
       <Text  fontSize={['65px' ,'60px' ,'60px' ,'100%' ,'20px' ,'20px']}  >
       ...
       <br/>
       <Text   fontSize={['65px' ,'60px' ,'60px' ,'100%' ,'20px' ,'20px']}  fontWeight='bold' >Time Management</Text>
       <Text fontSize={['65px' ,'60px' ,'60px' ,'100%' ,'20px' ,'20px']}  >
       ...
       <br/>
       <Text   fontSize={['65px' ,'60px' ,'60px' ,'100%' ,'20px' ,'20px']}  fontWeight='bold' >Regular check</Text>
       <Text  fontSize={['65px' ,'60px' ,'60px' ,'100%' ,'20px' ,'20px']}  >
     ...
     <Box mt='100px'  mb='100px'    w='75%'    textAlign={['center' , 'center','center','left','left','left']}     >  
